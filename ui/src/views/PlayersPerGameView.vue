...
<div style='padding:10px'>
  ...
  <div style="padding:15px">
    <DataTable stripedRows scrollHeight="60vh" :value="players" :paginator="true" :rows="10"
     dataKey="playerName" v-model:filters="filters" filterDisplay="menu" paginatorTemplate="CurrentPageReport FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink RowsPerPageDropdown"
      ...
      this.initFilters();
        ...
        initFilters() {
            this.filters = {
                ...
                'playerName': {operator: FilterOperator.AND, constraints: [{value: null, matchMode: FilterMatchMode.IN}]}
            }
        }
  }
};
